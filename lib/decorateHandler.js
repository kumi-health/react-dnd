...
var _utilsEqualArray = require('./utils/equalArray');

var _utilsEqualArray2 = _interopRequireDefault(_utilsEqualArray);
...
function decorateHandler(_ref) {
  ...
  return (function (_Component) {
    ...
    DragDropContainer.prototype.receiveType = function receiveType(type) {
      if (type === this.currentType || Array.isArray(type) && Array.isArray(this.currentType) && _utilsEqualArray2['default'](type, this.currentType)) {
        return;
      }
